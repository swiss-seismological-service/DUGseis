#  Adapted Obspy Sourcecode for Coincidence trigger used by trigger function of DUG-Seis
#
# :copyright:
...
def coincidence_trigger(trigger_type, thr_on, thr_off, stream,
    ...
    while triggers != []:
        ...
        sta = tr_id.split(".")[1]
        event = {}
        event['time'] = [UTCDateTime(on)] # added square brackets, Linus 22.10.2018_____
        ...
        for trigger in triggers:
            ...
            if details:
                ...
                event['time'].append(UTCDateTime(tmp_on))  # inserted by Linus 22.10.2018_____
